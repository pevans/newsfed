#!/bin/bash
# Run all CLI list command tests
...
run_test "$SCRIPT_DIR/test-basic.sh"
run_test "$SCRIPT_DIR/test-filters.sh"
run_test "$SCRIPT_DIR/test-sorting.sh"
run_test "$SCRIPT_DIR/test-pagination.sh"
run_test "$SCRIPT_DIR/test-formats.sh"
